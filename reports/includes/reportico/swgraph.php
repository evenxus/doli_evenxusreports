 ...
 * @package Reportico
 * @version $Id: swgraph.php,v 1.6 2011-09-22 21:57:30 peter Exp $
 */
...
class reportico_graph
{
	...
	var $gridpos_actual = "back";
	var $xgriddisplay_actual = "major";
	var $xgridcolor_actual = "gray";
	var $ygriddisplay_actual = "none";
	var $ygridcolor_actual = "gray";
	var $titlefont_actual = "";
	var $titlefontstyle_actual = "";
	var $titlefontsize_actual = "12";
	var $titlecolor_actual = "black";
	var $xtitlefont_actual = "";
	var $xtitlefontstyle_actual = "";
	var $xtitlefontsize_actual = "12";
	var $xtitlecolor_actual = "black";
	var $ytitlefont_actual = "";
	var $ytitlefontstyle_actual = "";
	var $ytitlefontsize_actual = "12";
	var $ytitlecolor_actual = "black";
	var $xaxisfont_actual = "";
	var $xaxisfontstyle_actual = "";
	var $xaxisfontsize_actual = "12";
	var $xaxisfontcolor_actual = "black";
	var $yaxisfont_actual = "";
	var $yaxisfontstyle_actual = "";
	var $yaxisfontsize_actual = "12";
	var $yaxisfontcolor_actual = "black";

	var $width_pdf = false;
	var $height_pdf = false;
	var $titlefont = "Font 1";
	var $titlefontstyle = "Normal";
	var $titlefontsize = 12;

	var $gridpos = "back";
	var $xgriddisplay = "major";
	var $xgridcolor = "gray";
	var $ygriddisplay = "none";
	var $ygridcolor = "gray";

	var $yaxiscolor = "black";
	var $yaxisfont = "Font 1";
	var $yaxisfontstyle = "Normal";
	var $yaxisfontsize = 8;
	var $yaxisfontcolor = "black";
	var $xaxiscolor = "black";
	var $xaxisfont = "Font 1";
	var $xaxisfontstyle = "Normal";
	var $xaxisfontsize = 8;
	var $xaxisfontcolor = "black";
	var $xtitlefont = "Font 1";
	var $xtitlefontstyle = "Normal";
	var $xtitlefontsize = 12;
	var $xtitlecolor = "black";
	var $xtickinterval = 2;
	var $xticklabelinterval = 2;
	var $ytitlefont = "Font 1";
	var $ytitlefontstyle = "Normal";
	var $ytitlefontsize = 12;
	var $ytitlecolor = "black";
	var $ytickinterval = 4;
	var $yticklabelinterval = 2;
	...
	function reportico_graph($in_val = "")
	{
	...
	function clear_data()
	{
		foreach ( $this->plots as $k => $v )
		{
			$this->plots[$k]["data"] = array();
		}
		$this->xlabels = array();
		$this->ylabels = array();
	}
	...
	function add_plot_value($in_query, $in_val)
	{
		$in_val = trim($in_val);
		if ( !$in_val )
			$in_val = 0;
		foreach ( $this->plots as $k => $v )
		{
			if ( $v["name"] == $in_query )
			{
				...
				{
					case "hhmmss":
						$this->plots[$k]["data"][] = hhmmss_to_seconds($in_val);
						break;

					default:
						$this->plots[$k]["data"][] = $in_val;
				}
			}
		}
	}
	...
	function generate_url_params($session_placeholder=false)
	{
		$this->apply_defaults();
		...
		//$result = '<img width="'.$width.'" src=\''.$dr.'/'.$dyngraph.'?'.$params.'&imagesql='.$imagesql.'\'>';
		$result = '<img class="swRepGraph" src=\''.$dr.
					'/'.$dyngraph.'?'.$url.'\'>';
	...
	function generate_graph_image ()
	{
		...
		if ( $this->plots[0]["type"] == "PIE" || $this->plots[0]["type"] == "PIE3D" )
		{

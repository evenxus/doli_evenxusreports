						...
						<td colspan=3>
							<TABLE class="noborder" style="width:100%">
								<TR class="liste_titre">
									<td width="20%">
										&nbsp;
										<input type="submit" class="swPrpSubmit" name="submit" value="Executer">
										<input type="submit" class="swPrpSubmit" name="clearform" value="Réinitialiser">
									</TD>
									...
									<td width="40%" style="vertical-align: top">
										<!--INPUT type="checkbox" name="target_attachment" value="1" {$OUTPUT_ATTACH}>Critères</INPUT-->
										&nbsp;
										Voir 
										<INPUT type="checkbox" name="target_show_criteria" value="1" {$OUTPUT_SHOWCRITERIA}>Critères</INPUT>
										<INPUT type="checkbox" name="target_show_body" value="1" {$OUTPUT_SHOWDET}>Détails</INPUT>
{if $OUTPUT_SHOW_SHOWGRAPH}
										<INPUT type="checkbox" name="target_show_graph" value="1" checked>Graphics</INPUT><BR>
{/if}
									</td>
								</TR>
							</TABLE>
...
{if !$REPORT_DESCRIPTION}
						Entrez les critères du rapport ici. Pour entrer les critères, vous devez utiliser les touches appropriées.
						Ensuite, sélectionnez le format de sortie approprié et cliquez sur Executer.
{else}
						{$REPORT_DESCRIPTION}
{/if}
</div>

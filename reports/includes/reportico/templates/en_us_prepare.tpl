							...
							<TABLE class="noborder" style="width:100%">
								<TR class="liste_titre">
									...
									<td width="40%" style="vertical-align: top">
										...
										&nbsp;
										Show 
										<INPUT type="checkbox" name="target_show_criteria" value="1" {$OUTPUT_SHOWCRITERIA}>Criteria</INPUT>
										<INPUT type="checkbox" name="target_show_body" value="1" {$OUTPUT_SHOWDET}>Detail</INPUT>

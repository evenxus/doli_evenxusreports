...
global $conf,$langs,$db, $dolibarr_main_db_pass;
...
define('SW_ALLOW_MAINTAIN', false);

//  Stylesheets
define('SW_STYLESHEET', 'stylesheet/coolandlight.css');
//define('SW_STYLESHEET', 'stylesheet/purplehaze.css');
//define('SW_STYLESHEET', 'stylesheet/mochaccino.css');
//define('SW_STYLESHEET', 'stylesheet/grey-n-green.css');
